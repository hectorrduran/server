...
exports = module.exports = internals.Route = function (route, connection, plugin, options) {
    ...
    var routeDisplay = route.method + ' ' + route.path;
    ...
    var handler = route.handler || config.handler;
...
internals.payload = function (request, next) {
    ...
    var onParsed = (err, parsed) => {
        ...
        var failAction = request.route.settings.payload.failAction;
