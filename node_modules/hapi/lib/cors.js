...
exports.handler = function (connection) {
    ...
    var route = new Route({ method: '_special', path: '/{p*}', handler: internals.handler }, connection, connection.server, { special: true });
...
internals.handler = function (request, reply) {
    ...
    var route = request.connection.match(method, request.path, request.info.hostname);
    if (!route) {
